...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Digital Library - Data E-Book</title>
                ...
                <div class="content">
                    ...
                    <div class="row items-push">
                        <div class="col-md-6 col-xl-4">
                            <div class="block block-rounded text-center">
                                <div class="block-content">
                                    <img class="img-avatar" src="<?= base_url() ?>public/assets/media/avatars/avatar2.jpg" alt="">
                                </div>
                                <div class="block-content block-content-full">
                                    <div class="font-size-h5 font-w600 mb-0">Alice Moore</div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="block block-rounded text-center">
                                <div class="block-content">
                                    <img class="img-avatar" src="<?= base_url() ?>public/assets/media/avatars/avatar5.jpg" alt="">
                                </div>
                                <div class="block-content block-content-full">
                                    <div class="font-size-h5 font-w600 mb-0">Carol Ray</div>
                        ...
                        <div class="col-xl-4">
                            <div class="block block-rounded text-center">
                                <div class="block-content">
                                    <img class="img-avatar" src="<?= base_url() ?>public/assets/media/avatars/avatar10.jpg" alt="">
                                </div>
                                <div class="block-content block-content-full">
                                    <div class="font-size-h5 font-w600 mb-0">Brian Cruz</div>
